...
spin_wc_result = meic.solve(system, bath, tlist=tlist, e_ops=e_ops, correlations="with", numerics=paper_numerics)
spin_woc_result = meic.solve(system, bath, tlist=tlist, e_ops=e_ops, correlations="without", numerics=paper_numerics)
