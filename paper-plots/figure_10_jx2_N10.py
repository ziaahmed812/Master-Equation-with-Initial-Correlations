...
system = meic.SystemParams(N=10, epsilon0=4.0, epsilon=3.5, delta0=0.5, delta=0.5)
bath = meic.BathParams(bath_type="bosonic", kind="ohmic", s=1.0, beta=1.0, coupling=0.05, omega_c=5.0)
tlist = np.linspace(0.0, 2.0, 21)
e_ops = ["jx^2"]
...
print(me_wc_result.e_data["jx^2"][:5])
print(me_woc_result.e_data["jx^2"][:5])
